	...
	$.fn.fullpage = function(options) {
		...
		$.fn.fullpage.setAutoScrolling = function(value){
			...
			if(options.autoScrolling){
				...
				$('body, html,#js-site-content').scrollTop(element.position().top);
			}
		...
		*/
		...
		var windowsHeight = $('.site-content').height();
		var isMoving = false;
		...
		$('#js-site-content').wrapInner('<div id="superContainer" />');
